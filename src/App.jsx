...
export default (props) =>
  <div className="App">
    ...
    <div className="Cards">
      ...
      <Card titulo="#09 - Input" color="#293E6A">
        <Input ></Input>
      </Card>
      ...
      <Card titulo="#07 - Comunicação Direta" color="#4298B5">
        <Pai sobrenome="Gomes"></Pai>
      </Card>
      <Card titulo="#06 - Condicional V2 - If" color="#FA6900">
        <CondicionalComIf numero={12}></CondicionalComIf>
      </Card>
      <Card titulo="#05 - Condicional V1 - TENARIO" color="#E94C6f">
      ...
      <Card titulo="#01 - Primeiro Componente" color="#92C0Ba">
        <Primeiro></Primeiro>
      </Card>
